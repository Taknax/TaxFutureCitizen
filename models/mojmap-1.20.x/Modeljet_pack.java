...
public class Modeljet_pack<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(8, 16)
				...
				.addBox(-4.0F, 1.0F, 2.0F, 3.0F, 9.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(0, 19)
				...
				.addBox(-3.0F, -0.5F, -2.5F, 1.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(0, 23)
		...
		PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(16, 16)
