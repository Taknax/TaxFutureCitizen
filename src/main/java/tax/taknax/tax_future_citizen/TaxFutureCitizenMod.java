...
@Mod("tax_future_citizen")
public class TaxFutureCitizenMod {
	public static final Logger LOGGER = LogManager.getLogger(TaxFutureCitizenMod.class);
	public static final String MODID = "tax_future_citizen";

	public TaxFutureCitizenMod(FMLJavaModLoadingContext context) {
