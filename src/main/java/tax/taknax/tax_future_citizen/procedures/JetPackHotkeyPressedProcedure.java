...
public class JetPackHotkeyPressedProcedure {
	public static void execute(Entity entity) {
		if (entity == null)
			return;
		if ((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.CHEST) : ItemStack.EMPTY).getItem() == TaxFutureCitizenModItems.SPACE_SUIT_CHESTPLATE.get() && entity.getPersistentData().getDouble("fuel") != 0) {
